package com.svetikov.eticket.eticketpayment.exception;
...
import com.svetikov.eticket.eticketpayment.exception.rest.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles DuplicateEntityException. Thrown when client trying to sent duplicate order payment
     * @param ex
     * @return
     */
    ...
    /**
     * Handles IllegalArgumentException. Happens when client user invalid request parameters or path variables
     *
    ...
    public ResponseEntity<Object> handleIlligalArgumentException(IllegalArgumentException ex) {
        ApiError apiError = new ApiError(BAD_REQUEST);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
